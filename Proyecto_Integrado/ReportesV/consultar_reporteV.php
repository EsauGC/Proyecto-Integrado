    ...
    <table class="Tb-Rv">
        <thead>
            <tr>
                ...
                <th>Usuario</th>
                <th>Importe Total</th>
                <th style="display: none;">Reporte detallado</th>
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            $sql .= "WHERE v.status = 1 AND v.fecha = '$fecha_hoy' ";
        ...
        while ($row = mysqli_fetch_assoc($resultado_hoy)) { ?>
            <tr>
                <td style="display: none;"><?php echo $row['id_venta']; ?></td>
                <td><?php echo $row['fecha']; ?></td>
                <td><?php echo $row['usuario']; ?></td>
                <td><?php echo number_format($row['total'], 2); ?></td>
                <td class='icono'>
                    <a href='reporteDT.php?id_venta= <?php echo $row['id_venta'];?>'>
